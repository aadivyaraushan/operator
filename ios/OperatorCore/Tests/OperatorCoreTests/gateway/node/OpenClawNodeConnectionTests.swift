...
final class OpenClawNodeConnectionTests: XCTestCase {
    ...
    func testConnectAdvertisesForegroundLocationAndCalendarAsAnIOSNode() async throws {
        ...
        XCTAssertEqual(params["commands"] as? [String], ["location.get", "calendar.events", "reminders.list", "contacts.search", "photos.latest", "music.nowPlaying", "music.search", "weather.forecast", "device.status", "sms.compose", "sms.send", "maps.search", "maps.directions", "apps.open", "whatsapp.chats", "whatsapp.messages", "whatsapp.sync", "whatsapp.compose", "connections.read", "connections.write", "connections.describe", "notion.tools", "notion.call", "youtube.search", "youtube.open", "podcasts.search", "podcasts.open", "discord.announcements"])
