...
public enum GatewayNativeNodeSurface {
    ...
    public static let commands = ["location.get", "calendar.events", "reminders.list", "contacts.search", "photos.latest", "music.nowPlaying", "music.search",
                                  "weather.forecast", "device.status", Self.messageComposeCommand, Self.messageSendCommand, "maps.search", "maps.directions", "apps.open", "whatsapp.chats", "whatsapp.messages", "whatsapp.sync", "whatsapp.compose", "connections.read", "connections.write", "connections.describe", "notion.tools", "notion.call", "youtube.search", "youtube.open", "podcasts.search", "podcasts.open", "discord.announcements"]
    public static let commandPolicyAllow = ["weather.forecast", "device.status", "music.nowPlaying", "music.search", Self.messageComposeCommand, Self.messageSendCommand, "maps.search", "maps.directions", "apps.open", "whatsapp.chats", "whatsapp.messages", "whatsapp.sync", "whatsapp.compose", "connections.read", "connections.write", "connections.describe", "notion.tools", "notion.call", "youtube.search", "youtube.open", "podcasts.search", "podcasts.open", "discord.announcements"]
