...
struct ChatActivityLabel: Equatable, Sendable {
    ...
    private static let known: [String: ChatActivityLabel] = [
        ...
        "messages.conversations": .init(live: "Checking conversations", done: "Checked conversations"),
        "messages_conversations": .init(live: "Checking conversations", done: "Checked conversations"),
        "messages.conversation": .init(live: "Updating a conversation", done: "Updated a conversation"),
